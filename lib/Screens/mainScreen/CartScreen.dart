...
class _CartScreenState extends State<CartScreen> {
  ...
  void _onLoading() async {
    ...
    if (nextPage != null) {
      ...
      if (mounted) {
        setState(() {});
        _refreshControllerCartScreen.loadComplete();
      }
    } else {
      if (mounted) {
        setState(() {});
        _refreshControllerCartScreen.loadNoData();
      }
    }
  }
  ...
  @override
  void initState() {
    _refreshControllerCartScreen = RefreshController(initialRefresh: false);
    _locale =
      ...
      builder: (context, cartProvider, child) => SmartRefresher(
        ...
        child: Scaffold(
          ...
          body: Container(
            ...
            padding:
                const EdgeInsets.only(left: 14.0, right: 14.0, bottom: 8.0),
            ...
            child: cartProvider.allProductsInCartStage ==
                        GetAllProductsInCartStage.DONE &&
                    cartProvider.getAllProductsInCart.specificProduct.isEmpty
                ? Column(
                    ...
                    children: [
                      Text(
                        AppLocalizations.of(context).locale.languageCode == "en"
                            ? 'There are no products in ${AppLocalizations.of(context).trans('cart')}'
                            : 'لايوجد منتجات فى ${AppLocalizations.of(context).trans('cart')} ',
                        ...
                        MediaQuery.removePadding(
                          ...
                          child: ListView.builder(
                              ...
                              child: cartProvider.allProductsInCartStage ==
                                  ...
                                  : defaultCard(
                                      productId: cartProvider
                                          ...
                                          .product
                                          .id,
                                      titleContent: cartProvider
                                          .getAllProductsInCart
                                          .specificProduct[index]
                                          .quantity,
                                      price: cartProvider.getAllProductsInCart
                                          .specificProduct[index].price,
                                      productSize: cartProvider.getAllProductsInCart
                                          .specificProduct[index].sizeName,
                                      productName: cartProvider
                                          .getAllProductsInCart
                                          .specificProduct[index]
                                          .product
                                          .title,
                                      imgUrl: cartProvider.getAllProductsInCart
                                          .specificProduct[index].product.image,
                                      context: context,
                                      currentIndex: index,
                                      media: media,
                                      onDeletePressed: () {
                                      ...
                                      onFavPressed: () async {
                                        bool result = await cartProvider
                            ...
                            itemCount: cartProvider.allProductsInCartStage ==
                                    GetAllProductsInCartStage.LOADING
                                ? 5
                                : cartProvider.getAllProductsInCart
                                    .specificProduct.length,
                          ),
                        ),
                        const SizedBox(
                          height: 12.0,
